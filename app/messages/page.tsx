...
<input value={text} onChange={e=>setText(e.target.value)} onKeyDown={e=>e.key==='Enter'&&send()} className="flex-1 bg-zinc-800 rounded-full px-4 py-2" placeholder="Type a message..."/>
