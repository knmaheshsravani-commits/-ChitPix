        ...
        <div className="max-w-[600px] mx-auto">
          <div className="sticky top-0 bg-white p-3 border-b border-zinc-200 z-10">
            <div className="flex items-center bg-zinc-100 rounded-lg px-3 py-2">
              ...
              {search && <button onClick={() => setSearch("")} className="text-zinc-600 ml-2">✕</button>}
            </div>
          </div>
