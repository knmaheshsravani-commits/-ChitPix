...
<header className="p-3 flex justify-between border-b border-gray-800 items-center"><h1 className="font-bold">ChitPix</h1><Link href="/messages" className="bg-white text-black px-3 py-1 rounded-full text-sm font-bold">DM 💬</Link></header>
