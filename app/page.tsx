  ...
  <div className="flex gap-4 items-center">
    ...
    <button onClick={() => setIsLogin(false)} className="border border-white text-white px-3 py-1 rounded-full text-[16px] font-bold">Logout</button>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t flex justify-around p-3 z-50">
        ...
        <button onClick={() => { const txt = prompt("New Post / Reel:"); if (txt) { const isReel = confirm("Reel? OK=Reel"); setThreads([{ id: Date.now(), user: username || "knmahesh30", text: txt, likes: 0, isReel },...threads]); } }} className="bg-black text-white w-9 h-9 rounded-xl">+</button>
